...
class RemoteSubmission:
    ...
    allocation declares and reclaims the shortfall from a job that declares less than it holds, so the resident figure
    is the one it is given. The request itself is this figure rounded up to whole gigabytes and floored at one."""
    output_log: str = ""
