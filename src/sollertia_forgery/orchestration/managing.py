"""Provides the remote orchestrators for the system-agnostic management pipelines: project manifest resolution and
session raw-data integrity checksum verification on the remote compute server.
"""
