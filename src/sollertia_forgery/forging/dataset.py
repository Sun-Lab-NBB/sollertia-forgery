...
def _create_dataset(
    ...
    *,
    ...
    the created dataset, resolved from the central forging registry.
    ...
    # Resolves the acquisition system's column descriptions so the created dataset carries the per-dataset
    # ``data_descriptions.feather`` binding for the data its assembly worker emits.
