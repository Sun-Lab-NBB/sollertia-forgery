...
def assemble_runtime_dataset(
    ...
    Args:
        ...
        experiment_configuration: The MesoscopeExperimentConfiguration loaded from the session's raw data, used to map
            integer trial type and runtime state codes to descriptive names.
