...
import pytz
import polars as pl
from sollertia_shared_assets import ProjectManifest
...
def make_manifest_from_structure(project_name: str, sessions: list[dict], out_dir: Path) -> Path:
    ...
    Optional keys (default False/'N/A'):
      - notes, complete, integrity, cindra, behavior, video, dataset
    ...
    for row in sessions:
        ...
        for key in ("complete", "integrity", "cindra", "behavior", "video", "dataset"):
